...
try {
  ...
  $vendor_cordes = $stmt_select->fetchAll(PDO::FETCH_COLUMN);
      ...
      <article class="registration">
        ...
        <form action="create.php" method="post" class="registration-form">
          <div>
            ...
            <input type="number" id="product_code" name="product_code" min="0" max="1000000000" required>
            ...
            <select name="vendor_code" id="vendor_code" required>
              ...
              <?php
              foreach ($vendor_cordes as $vendor_code) {
